...
final class GoalTests: XCTestCase {
  ...
  func createTestUser(context: NSManagedObjectContext) -> User {
    return User(
      context: context, username: "test-user", deadbeat: false, timezone: "Etc/UTC",
      updatedAt: Date(timeIntervalSince1970: 0), defaultAlertStart: 0, defaultDeadline: 0, defaultLeadTime: 0)
  }
