...
class HealthKitConfig : NSObject {
    ...
    var metrics : [HealthKitMetric] {
        return [
            ...
            SleepAnalysisHealthKitMetric.init(humanText: "Time in bed", databaseString: "timeInBed", hkCategoryTypeIdentifier: HKCategoryTypeIdentifier.sleepAnalysis, hkCategoryValueSleepAnalysis: HKCategoryValueSleepAnalysis.inBed),
            SleepAnalysisHealthKitMetric.init(humanText: "Time asleep", databaseString: "timeAsleep", hkCategoryTypeIdentifier: HKCategoryTypeIdentifier.sleepAnalysis, hkCategoryValueSleepAnalysis: HKCategoryValueSleepAnalysis.asleep),
