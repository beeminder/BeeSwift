  ...
  override func viewDidLoad() {
    ...
    currentMetricLabel.attributedText = {
      ...
      attrString.append(
        NSMutableAttributedString(
          string:
            "This goal obtains its data from Apple Health (\(self.goal.humanizedAutodata!)). You can disconnect the goal with the button below.",
          attributes: [
    ...
    Task { @MainActor in
      do {
        ...
        NotificationCenter.default.post(
          name: CurrentUserManager.NotificationName.healthKitMetricRemoved, object: self,
