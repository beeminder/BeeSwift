...
class SettingsViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    versionLabel.snp.makeConstraints { (make) in make.width.equalTo(self.view) }
  ...
  @objc func userDefaultsDidChange() { DispatchQueue.main.async { self.tableView.reloadData() } }
  ...
  @objc func showLogsTapped() { coordinator?.showLogs() }
