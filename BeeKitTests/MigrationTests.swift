...
class MigrationTests: XCTestCase {
  ...
  private func createStoreWithOldModel() -> URL {
    ...
    guard
      let oldVersionURL = bundle.url(
        forResource: "BeeminderModel", withExtension: "mom", subdirectory: "BeeminderModel.momd"),
  ...
  func testLastUpdatedLocalMigration() throws {
    ...
    if let user = users.first {
      XCTAssertEqual(
        user.lastUpdatedLocal.timeIntervalSince1970, TestData.userLastModified.timeIntervalSince1970,
    ...
    if let goal = goals.first {
      XCTAssertEqual(
        goal.lastUpdatedLocal.timeIntervalSince1970, TestData.goalLastModified.timeIntervalSince1970,
    ...
    if let dataPoint = dataPoints.first {
      XCTAssertEqual(
        dataPoint.lastUpdatedLocal.timeIntervalSince1970, TestData.dataPointLastModified.timeIntervalSince1970,
