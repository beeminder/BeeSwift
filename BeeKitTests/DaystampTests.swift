...
final class DaystampTests: XCTestCase {
  ...
  func testCanCalculateBoundsForZeroDeadline() throws {
    XCTAssertEqual(
      Daystamp(year: 1970, month: 1, day: 1).start(deadline: 0), date(year: 1970, month: 1, day: 1, hour: 0, minute: 0))
    XCTAssertEqual(
      Daystamp(year: 1970, month: 1, day: 1).end(deadline: 0), date(year: 1970, month: 1, day: 2, hour: 0, minute: 0))
  }
