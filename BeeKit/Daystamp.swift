...
public struct Daystamp: CustomStringConvertible, Strideable, Comparable, Equatable, Hashable {
  ...
  private static let daystampPattern = try! NSRegularExpression(
  ...
  public func distance(to other: Daystamp) -> Int {
    let selfDate = Daystamp.calendar.date(
      from: DateComponents(calendar: Daystamp.calendar, year: year, month: month, day: day)
    )!
    let otherDate = Daystamp.calendar.date(
      from: DateComponents(calendar: Daystamp.calendar, year: other.year, month: other.month, day: other.day)
    )!
  ...
  public func advanced(by n: Int) -> Daystamp {
    let date = Daystamp.calendar.date(
      from: DateComponents(calendar: Daystamp.calendar, year: year, month: month, day: day)
    )!
