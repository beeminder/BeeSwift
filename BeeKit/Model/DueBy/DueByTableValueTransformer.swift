...
@objc(DueByTableValueTransformer) public class DueByTableValueTransformer: ValueTransformer {
  ...
  public override func reverseTransformedValue(_ value: Any?) -> Any? {
    ...
    do { return try JSONDecoder().decode(DueByDictionary.self, from: data) } catch {
...
extension DueByTableValueTransformer {
  public static var name: NSValueTransformerName {
    .init(rawValue: String(describing: DueByTableValueTransformer.self))
  }
  public static func register() {
    ValueTransformer.setValueTransformer(DueByTableValueTransformer(), forName: DueByTableValueTransformer.name)
  }
}
