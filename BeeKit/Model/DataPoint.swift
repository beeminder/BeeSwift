...
public class DataPoint: NSManagedObject, BeeDataPoint {
  ...
  public init(
    context: NSManagedObjectContext, goal: Goal, id: String, comment: String, daystamp: Daystamp, requestid: String,
    value: NSNumber, updatedAt: Int, isDummy: Bool = false, isInitial: Bool = false
  ) {
